...
export const DragAndDropItem = memo(
    ({
        as,
        entityId,
        entityType,
        ...
        const [isDraggedAway, setIsDraggedAway] = useState<boolean>(false);
        ...
        const handleDragEnter = (e: React.DragEvent<HTMLElement>) => {
            const { id: draggableId } = getDraggingInfo<DraggingEventData<DraggingEntityType>>(e);
